import type {
  PainPoint, HowItWorksStep, Feature,
  PricingTier, TrustItem, DashboardMetric, AllocationItem,
} from '../types';

// ─── Dashboard mockup data ────────────────────────────────────────────────────

export const dashboardMetrics: DashboardMetric[] = [
  { label: 'Safe to Spend',   value: '$3,840', subtext: 'After reserves & taxes', color: '#27AE60', trend: '↑ Healthy' },
  { label: 'Runway',          value: '6.2 mo', subtext: 'At current spend rate',  color: '#4C5FD5', trend: '' },
  { label: 'Tax Reserve',     value: '$2,100', subtext: 'Set aside this year',    color: '#D4A800', trend: '' },
  { label: 'Smoothed Income', value: '$7,200', subtext: '6-month rolling avg',    color: '#8B5CF6', trend: '' },
];
...
export const incomeSparkData = [3200, 5800, 2100, 7400, 6200, 4900, 8100, 5400, 7200];
...
export const painPoints: PainPoint[] = [
  {
    ...
    description: 'A $12k month followed by a $1.5k month makes it impossible to know what you can actually afford.',
  },
  {
    icon: '😰',
    title: 'Tax time is a nightmare',
    description: 'You spend freely all year then get hit with a surprise tax bill. Sound familiar? You\'re not alone.',
  },
  {
    icon: '🤷',
    title: '"Can I spend this?" is unanswerable',
    description: 'You check your bank balance but that number lies. It doesn\'t account for tax, emergencies, or slow months ahead.',
  },
];
...
export const pricingTiers: PricingTier[] = [
  {
    ...
    price: 0,
    period: 'forever',
    description: 'For freelancers just getting started with cash flow awareness.',
    features: [
