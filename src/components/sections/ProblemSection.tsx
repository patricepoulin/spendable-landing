  ...
  return (
    ...
    >
      <Box
        ...
        h='500px'
        borderRadius='full'
        bg='radial-gradient(circle, rgba(124,92,246,0.18) 0%, transparent 65%)'
        pointerEvents='none'
      />
      <Box
        position='absolute'
        ...
        h='400px'
        borderRadius='full'
        bg='radial-gradient(circle, rgba(76,95,213,0.12) 0%, transparent 65%)'
        pointerEvents='none'
      />
      ...
      <Box maxW='1100px' mx='auto' px={{ base: 5, md: 8 }} position='relative'>
        ...
        <Text
          ...
          mb={14}
        >
          It doesn't know about your tax bill, your dry month coming up, or the
          emergency buffer you promised yourself you'd keep.
        </Text>
          ...
          {PAIN_POINTS.map((point) => (
            ...
            >
              ...
              <Box
                ...
                right={0}
                h='3px'
                bg={`linear-gradient(90deg, ${point.iconColor}cc, transparent)`}
              />
              ...
              <Box
                ...
                mb={5}
              >
                <Icon as={point.icon} color={point.iconColor} boxSize='20px' />
              </Box>
        ...
        >
          ...
          <Text fontSize='15px' color={PURPLE.muted}>
            Not{' '}
            <Box as='span' fontStyle='italic'>
              "what's in my account?"
            </Box>{' '}
            but{' '}
            <Box as='span' fontWeight='700' color={PURPLE.accentSoft}>
