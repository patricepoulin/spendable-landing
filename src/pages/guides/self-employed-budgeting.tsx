...
export default function SelfEmployedBudgetingPage() {
  return (
    <SEOPageLayout
      meta={{
        title: 'Self-Employed Budgeting: The Framework That Actually Works',
        description:
          "Traditional budgets assume a fixed salary. Here's the 4-bucket system that works when income changes every month.",
        canonical: '/guides/self-employed-budgeting',
      }}
    >
      <ArticleHeader
        tag='Budgeting Guide'
      ...
      <P>
        Employee budgets work because the input is fixed. The 50/30/20 rule
        divides a predictable pie. Freelance income is different — one client
        can account for 70% of your revenue, your best and worst months might be
        separated by £8,000.
      </P>
      <P>
        The right approach budgets against your <em>smoothed average income</em>{' '}
        — what you typically earn — and maintains buffers that absorb the
        variance.
      </P>

      <SectionHeading>The 4-bucket framework</SectionHeading>
      <P>
        Instead of a monthly budget, maintain four permanent buckets. Every
        payment flows through all four.
      </P>
        ...
        {BUCKETS.map((b) => (
          ...
          >
            ...
            <HStack spacing={2} mb={2}>
              <Text fontWeight='800' fontSize='15px' color='#1C2B3A'>
                {b.title}
              </Text>
              <Box px={2} py={0.5} bg='white' borderRadius='full'>
                <Text fontSize='11px' fontWeight='700' color={b.color}>
                  {b.rate}
                </Text>
              </Box>
            </HStack>
      ...
      <InlineCTA
        ...
        cta='Try it free'
        utmRef='seo-budgeting-1'
      />

      <SectionHeading>
        The key: spending from your smoothed average
      </SectionHeading>
      <P>
        Income smoothing means basing your spending on your average income over
        the last 3–6 months, not on what arrived this week. It's the single most
        important technique for financial stability as a freelancer.
      </P>
      ...
      >
        <Box px={5} py={4} bg='#f8fafc' borderBottom='1px solid #E8E8E3'>
          <Text fontWeight='700' fontSize='13px' color='#1C2B3A'>
            Without vs with income smoothing — same 6 months
          </Text>
        </Box>
        <Box overflowX='auto'>
          <Table size='sm'>
            <Thead bg='#f8fafc'>
              <Tr>
                ...
                <Th py={3} fontSize='11px' color='#27AE60'>
                  With smoothing
                </Th>
              </Tr>
            </Thead>
            <Tbody>
              {[
                ...
                <Tr key={m} _hover={{ bg: '#f8fafc' }}>
                  ...
                  <Td py={3} fontSize='13px' color='#27AE60'>
                    {s}
                  </Td>
                </Tr>
              ))}
        ...
        <Box px={5} py={3} bg='#f8fafc' borderTop='1px solid #E8E8E3'>
          <Text fontSize='12px' color='#5a6a7a'>
            6-month avg: £5,400 → after 30% tax = £3,780. Smoothed monthly spend
            ≈ £3,600.
          </Text>
        </Box>
      </Box>
      ...
      <P>
        Runway is the most important number for any freelancer: how long you
        could cover essential expenses if all client work stopped tomorrow.
      </P>
      <P>
        A healthy runway is 3–6 months of essential expenses. Less than 3 months
        means a slow period could become a crisis. More than 6 months may mean
        holding cash that could be deployed more productively.
      </P>
      ...
      >
        ...
        <Text fontSize='14px' color='#5a6a7a' lineHeight='1.7'>
          Balance − Tax Reserve − Emergency Buffer − Upcoming Bills ={' '}
      ...
      <InlineCTA
        ...
        cta='Calculate my safe-to-spend'
        utmRef='seo-budgeting-2'
      />
      <RelatedPages
        links={[
          {
            ...
            desc: 'The complete guide to calculating and managing your tax reserve.',
          },
          {
            href: '/guides/freelance-income-smoothing',
            label: 'What is income smoothing?',
            desc: 'How averaging your income prevents feast-and-famine overspending.',
          },
          {
            href: '/guides/freelance-emergency-fund',
            label: 'How much emergency fund does a freelancer need?',
            desc: "Why 3 months isn't always enough, and how to find your number.",
          },
        ]}
      />
    </SEOPageLayout>
