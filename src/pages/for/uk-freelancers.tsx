...
export default function ForUkFreelancersPage() {
  return (
    <SEOPageLayout
      maxW='860px'
      meta={{
        title: 'Finance App for UK Freelancers — Self-Assessment Made Simple',
        description:
          'Spendable tracks your UK self-assessment tax reserve, shows 31 Jan and 31 Jul deadlines, and gives you a live safe-to-spend in GBP.',
        canonical: '/for/uk-freelancers',
      }}
    >
      ...
      >
        ...
        <Text
          ...
          position='relative'
        >
          Spendable tracks your rolling self-assessment tax reserve, monitors
          your 31 January and 31 July payment deadlines, and shows a live
          safe-to-spend figure in GBP — updated with every income entry.
        </Text>
        <HStack spacing={3} flexWrap='wrap' position='relative'>
          <Button
            as='a'
            href={`${APP_URL}?ref=for-uk`}
            bg='#4C5FD5'
            color='white'
            fontWeight='700'
            fontSize='15px'
        ...
        {[
          {
            ...
            body: 'Enter your effective Income Tax + NI rate. Most UK freelancers earning £30k–£80k use 25–30%.',
          },
          {
            s: '2',
            title: 'Log your income',
            body: 'Add each payment as it arrives. Spendable tracks source, date, and amount — building your rolling reserve automatically.',
          },
          {
            s: '3',
            title: 'Add recurring expenses',
            body: 'Add monthly outgoings — rent, software, insurance. Used to calculate your safe-to-spend and runway.',
          },
          {
            s: '4',
            title: 'Know your number',
            body: 'Your dashboard shows live safe-to-spend in GBP — current balance minus tax reserve, buffer, and upcoming bills.',
          },
        ].map((item) => (
      ...
      />
      <P>
        Upgrade to Pro (£8/mo) for unlimited income tracking, Tax Tracker with
        31 Jan/31 Jul deadlines, 6-month forecast, CSV export, and full income
        smoothing analysis.
      </P>
        ...
        links={[
          {
            ...
            desc: 'Full guide to calculating your reserve and avoiding the January panic.',
          },
          {
            href: '/guides/self-employed-tax-uk',
            label: 'UK self-assessment: a complete guide',
            desc: 'Deadlines, payments on account, and what to expect from HMRC.',
          },
          {
            href: '/guides/self-employed-budgeting',
            label: 'Self-employed budgeting for irregular income',
            desc: 'The 4-bucket framework for when income changes every month.',
          },
        ]}
      />
    </SEOPageLayout>
